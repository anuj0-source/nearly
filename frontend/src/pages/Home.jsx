...
function Home({ darkMode, onToggleTheme }) {
  ...
  async function handleAnonymousChat() {
    try {
      setLoading(true);

      const response = await fetch(
        `${backendUrl}/api/session/anonymous`,
        {
          method: "POST",
          credentials: "include",
        },
      ...
      <section className="home-stage">
        <div className="home-inner">
          ...
          <p className="home-sub">
            A random chat alternative to find friends, connect with people, and
            talk to strangers nearby — anonymously.
          </p>
          ...
          <div className="home-cta">
            <button
              ...
              disabled={loading}
            >
              {loading ? "Finding your space..." : "Talk Anonymously"}
            </button>
            <button
          ...
          <div style={{ textAlign: "center", marginTop: 16 }}>
            <p className="home-foot">
              <Shield size={11} strokeWidth={1.8} /> No account required. Your
